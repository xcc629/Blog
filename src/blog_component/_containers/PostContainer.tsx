    ...
    <div className={styles.main}>
      <Link href={"/series/1"}>
        <nav className={`${styles.flexRightCenter} ${styles.nav}`}>
          <ArrowIcon />
          <Typograpy margin="0 0 0 12px" size={20} weight={500}>
            시리즈 전체 보러가기
          </Typograpy>
        </nav>
      </Link>
      ...
      <div className={`${styles.flexBetween} ${styles.titleWrapper}`}>
        <div>
          <Typograpy size={20} weight={500} color="gray300" margin="0 0 8px 0">
            시리즈 제목
          </Typograpy>
        ...
        <div className={styles.flexRightBottom}>
          <Typograpy size={18} weight={500} color="gray200">
            삭제하기
          </Typograpy>
          <Typograpy size={18} weight={500} color="gray200" margin="0 27px">
            수정하기
          </Typograpy>
          <Typograpy size={18} weight={500} color="gray200">
            2023.01.03
      ...
      <div>
        <div className={`${styles.flexRightCenter} ${styles.nextPreTab}`}>
          <Typograpy size={18} weight={500} color="gray300" margin="0 66px 0 0">
            다음글
          </Typograpy>
